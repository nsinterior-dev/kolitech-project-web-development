    ...
    <div class="box">
        <div class="instructions-wrapper" style="overflow-y: hidden; scroll-behavior: unset;">
            ...
            <div class="instructions-title">
                <p class="instructions-title-p">Change the Color of Text</p>
            </div>
            <div class="instructions-paragraph" style="height: 38vh;">
                <p class="instruction-line">Now let's change the color of some of our text.</p>
                <p class="instruction-line">
                    We can do this by changing the <code>style</code> of your <code>h2</code> element.
                </p>
                <p class="instruction-line">The property that is responsible for the color of an element's text is the <code>color</code>style property.
                   </p>
                <p class="instruction-line">Here's how you would set your <code>h2</code> element's text color to blue:
                </p>
                <p class="instruction-line">
            ...
            <div class="real-instruction">
                <p class="rl-line">Change the color of <code>h3</code>,<code>p</code>,and <code>li</code> elements into red, blue and yellow.</p>
...
<textarea id="code">
    ...
    <ul>
        ...
        <li>Laptop</li>
            ...
            <div class="buttons">
                <input type="submit" style="width: 12vw;" value="NEXT" onclick="document.location.href='workshop-position-css.php?origin=signIn'" id="runbtn" class="btn">
            </div>
        </div>
