<?php
// this page is for web development under workshop
// this page has the ff.
// title of workshop
// introduction-description
// intended learning outcomes
// a video about web development
// and a button linking to web development enroll
...
<head>
    ...
    <link href="css/workshow-web-dev.css"  rel="stylesheet">
...
<div class="content" id="content">
    <div class="row">
        <h2 class="workshop-web-dev-title">Web Development</h2>
        <hr>
    </div>
    <div class="row-1-col-1">
        <div class="insight">
            ...
            <p class="insight-paragraph">
                It is a way to make people aware of the services and/or products you are offering, understand why your products are relevant and even necessary for them to buy or use, and see which of your company's qualities set it apart from competitors.
            </p>
        </div>
        <div class="ILO">
            <h5 class="ILO-title">
            ...
            <ul class="workshop-web-dev-ilo-list">
                <li>
                ...
                <li>Understand how to plan and conduct user research related to web usability</li>
                <li>Learn the language of the web: HTML and CSS.</li>
                <li>Learn techniques of responsive web design, including media queries.</li>
                <li>Develop basic programming skills using Javascript and jQuery.</li>
        ...
        <div class="enroll-now">
            <button class="enroll-now-btn" id="enroll-btn">Start your own website!</button>
        </div>
    </div>
    <div class="row-1-col-2">
        <video style="position: relative; top: -8vh;border: none;outline: none;" height="420" width="560" controls>
            <source src="video/webdev.mp4" type="video/mp4">
        </video>
    </div>
    <div class="modal" id="modal">
        ...
        <div class="modal-body">
            <p class="text">
                Are you ready to take Web Development to learn at your own pace?
            </p>
            <button class="no" id="no">I am not ready</button>
            <form class="yes-form" method="post">

                <input type="submit" value="I am ready" class="yes" id="yes" name="submit">
            </form>
        </div>
    </div>
    <div id="overlay"></div>
