<?php
// this page is for data science under workshop
// this page has the ff.
// title of workshop
// introduction-description
// intended learning outcomes
// a video about data science
// and a button linking to data science enroll
...
<head>
    ...
    <link href="css/workshow-data-science.css"  rel="stylesheet">
    ...
    <title>Workshop - Data Science</title>
</head>
<style>
    .content{
        height:120vh ;
...
<div class="content" id="content">
    <div class="row">
        <h2 class="workshop-data-science-title">Data Science</h2>
        <hr>
    </div>
    <div class="row-1-col-1">
        ...
        <div class="ILO">
            ...
            <ul class="workshop-data-science-ilo-list">
                <li>
                ...
                <li>Execute statistical analyses with professional statistical software.</li>
        ...
        <div class="enroll-now">
            <button class="enroll-now-btn" id="enroll-btn">Learn Data Science</button>
        </div>
    </div>
    <div class="row-1-col-2">
            <video style="position: relative; top: -8vh;border: none; outline: none;" height="420" width="560" controls>
                <source src="video/datsci.mp4" type="video/mp4">
            </video>
    </div>
